...
from database import add_user_products, user_exists, get_user_products, get_all_products, get_all_products_name, get_product
...
#print(get_user_products("fxop02"))
#get_all_products("fxop02")
print(check_existence(URL))
print(get_product(URL))
get_all_products_name("fxop02")
